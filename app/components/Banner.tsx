...
export default function Banner() {
  ...
  return (
    <main
      ...
      <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 1.4, delay: 0.2 }}
        className="pointer-events-none absolute right-8 top-16 hidden md:block"
        style={{backgroundImage: `radial-gradient(circle, rgba(0,121,121,0.22) 1.2px, transparent 1.2px)`,
          backgroundSize: "18px 18px",width: "180px",height: "180px", borderRadius: "4px",}}/>

      {/* Dot-matrix accent */}
      <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 1.4, delay: 0.3 }}
        className="pointer-events-none absolute bottom-24 left-6 hidden md:block"
        style={{ backgroundImage: `radial-gradient(circle, rgba(0,121,121,0.18) 1.2px, transparent 1.2px)`,
          backgroundSize: "18px 18px", width: "140px", height: "140px", borderRadius: "4px",}}/>

      {/* Large blurred glow — teal, center-left */}
      <div className="pointer-events-none absolute" style={{width: "520px",height: "520px",top: "50%",left: "12%",
          transform: "translate(-50%, -55%)", background: "radial-gradient(circle, rgba(0,200,180,0.13) 0%, transparent 70%)",
          filter: "blur(40px)"}}/>

      {/* Large blurred glow — warm, center-right */}
      <div className="pointer-events-none absolute"
        style={{width: "460px", height: "460px", top: "60%", right: "8%", transform: "translate(30%, -50%)",
          background: "radial-gradient(circle, rgba(0,121,121,0.09) 0%, transparent 70%)",filter: "blur(48px)",}}/>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={inView ? { opacity: 1, scale: 1 } : {}}
        ...
        style={{width: "88px",height: "88px",borderRadius: "50%",border: "1.5px solid rgba(0,121,121,0.25)",
      ...
      <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={inView ? { opacity: 1, scale: 1 } : {}}
        ...
        style={{ width: "56px", height: "56px", borderRadius: "50%", border: "1.5px solid rgba(0,121,121,0.2)"}}/>

      {/* Corner bracket — top-right */}
      <motion.svg initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.8, duration: 0.6 }}
      ...
      <motion.svg initial={{ opacity: 0 }}animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.9, duration: 0.6 }}
        className="pointer-events-none absolute bottom-10 left-10 hidden md:block" width="40" height="40" viewBox="0 0 40 40" fill="none">
      ...
      <motion.div initial={{ scaleX: 0 }} animate={inView ? { scaleX: 1 } : {}} transition={{ delay: 0.55, duration: 1.2, ease: [0.22, 1, 0.36, 1] }}
      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div initial={{ opacity: 0, y: -12 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ delay: 0.1, duration: 0.6 }} className="mb-6 flex items-center justify-center gap-2">
            <span className="inline-block h-px w-10" style={{ background: "rgba(0,121,121,0.45)" }}/>
            <span className="rounded-full px-4 py-1 text-[11px] uppercase tracking-[0.22em]"
              style={{color: "#007979", background: "rgba(0,121,121,0.07)", 
              border: "1px solid rgba(0,121,121,0.18)", letterSpacing: "0.22em"}}>
              Portfolio
            </span>
            <span className="inline-block h-px w-10" style={{ background: "rgba(0,121,121,0.45)" }}/>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-8 md:mt-14 flex flex-col items-center gap-2">
            <span
